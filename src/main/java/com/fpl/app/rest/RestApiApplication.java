...
public class RestApiApplication {
    ...
    /**
     * A method to convert the output JSON formatted String, obtained from the GET request, into a human readeable JSON. This returns the entire JSON object as a string. If you are looking to get only certain keys from the JSON map use the overload version of this method that takes keyName(s) as a String parameter. 
     * 
     * @param outputBody the string returned from https GET request, written in JSON format
     * @return a readeable string that can be printed in an easy to read way
     * @throws JsonProcessingException if there is an error reading the JSON formatted string
     */
    ...
    /**
     * A method to convert the output JSON formatted String, obtained from the GET request, into a human readeable JSON. This version of the method returns an ArrayList<String> where each String is the value of the given keys.
     * @param outputBody the string returned from https GET request, written in JSON format
     ...
     */
    private static String[] convertToReadableJSON(String outputBody, String... keyNames) throws JsonProcessingException { 
        ObjectMapper objmapper = new ObjectMapper();
        Map<String, Object> jsonMap = objmapper.readValue(outputBody, new TypeReference<Map<String, Object>>() {});
    ...
    public static String getPlayerInfo() throws IOException {
        return connectToAPI(my_info_url);
    }
